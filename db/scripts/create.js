...
await pool.query(
  "Create table if not exists patient (patient_id INT PRIMARY KEY GENERATED ALWAYS AS IDENTITY, firstName text, surname TEXT, title TEXT, address TEXT, pregnant BOOLEAN, dob TEXT, gender TEXT, gpSurgery TEXT, nhsNumber INT, phoneNumber INT, postcode TEXT, email TEXT, prepaid TEXT, weight number); "
);
